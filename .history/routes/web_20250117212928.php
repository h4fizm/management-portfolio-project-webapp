...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/manage-project/edit/{id}', [ProjectController::class, 'editProject'])->name('edit-project');
    Route::put('/manage-project/update/{id}', [ProjectController::class, 'updateProject'])->name('update-project');
