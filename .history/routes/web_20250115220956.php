...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/file/upload', [ProfileController::class, 'uploadResume'])->name('file.upload');
    Route::delete('/file/revert', [ProfileController::class, 'revertResume'])->name('file.revert');
});