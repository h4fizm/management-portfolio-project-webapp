...
let swiperPortfolio = new Swiper(".services-box-services", {
  loop: true,
  spaceBetween: 20, // Adjust spacing between slides for better mobile appearance
  ...
  on: {
    init: function () {
      if (this.slides.length <= 1) {
        ...
        this.slides[0].style.opacity = 1; // Display the first slide if there's only one
    ...
    slideChange: function () {
      ...
      this.slides[this.activeIndex].style.opacity = 1; // Show the active slide
    },
  },
});
