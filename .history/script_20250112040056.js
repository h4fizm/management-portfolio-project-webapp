...
let swiperPortfolio = new Swiper(".services-box-services", {
  ...
  touchStartPreventDefault: false, // Pastikan touch event bisa dikenali
  on: {
    init: function () {
    ...
    slideChange: function () {
      ...
      this.slides.forEach((slide) => {
        slide.style.visibility = "hidden"; // Menggunakan visibility
        slide.style.opacity = 0; // Set opacity ke 0
      });
