...
function updateSwiperForMobile() {
  ...
  if (isMobile) {
    ...
    swiperPortfolio.params.spaceBetween = 20; // Adjust spacing for mobile
  } else {
...
let swiperPortfolio = new Swiper(".services-box-services", {
  ...
  slidesPerView: 1, // Tampilkan hanya 1 slide
  spaceBetween: 20, // Tambahkan jarak antar slide
  navigation: {
    nextEl: ".swiper-button-next",
    prevEl: ".swiper-button-prev",
  },
  ...
  on: {
    init: function () {
      ...
      if (this.slides.length <= 1) {
        this.loop = false; // Nonaktifkan loop jika hanya ada 1 slide
        this.navigation.nextEl.style.display = "none";
        this.navigation.prevEl.style.display = "none";
      } else {
        this.navigation.nextEl.style.display = "";
...
function updateSwiperForMobile() {
  ...
  if (isMobile) {
    ...
    swiperPortfolio.params.spaceBetween = 10; // Atur jarak antar slide
  } else {
    swiperPortfolio.params.slidesPerView = 1; // Tetap 1 slide untuk desktop
    swiperPortfolio.params.spaceBetween = 20; // Atur jarak antar slide
  }
  swiperPortfolio.update(); // Terapkan perubahan
}

// Panggil fungsi pada load dan resize
updateSwiperForMobile();
window.addEventListener("resize", updateSwiperForMobile);
