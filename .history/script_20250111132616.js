...
let swiperPortfolio = new Swiper(".services-box-services", {
  loop: true,
  spaceBetween: 0, // Menghapus jarak antar slide
  slidesPerView: 1, // Menampilkan satu slide di tengah
  centeredSlides: true, // Menempatkan slide aktif di tengah
  navigation: {
  ...
  // Breakpoints untuk menyesuaikan ukuran slide pada berbagai layar
  breakpoints: {
    640: {
      slidesPerView: 1, // Tampilan 1 slide di mobile
    },
    768: {
      slidesPerView: 1, // Tampilan 1 slide di tablet dan layar lebih besar
    },
  },
});
