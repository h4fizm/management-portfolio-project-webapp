...
class ProfileController extends Controller
{
    ...
    {
        // Menentukan path ke file yang berada di dalam public/storage/resumes/
        $path = public_path('app/public/resumes' . $filename);

        // Cek apakah file ada
        if (file_exists($path)) {
            return response()->file($path); // Mengembalikan file jika ditemukan
        } else {
            return abort(404, 'File not found'); // Jika file tidak ditemukan
        }
    }
