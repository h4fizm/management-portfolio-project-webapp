...
let swiperPortfolio = new Swiper(".services-box-services", {
  ...
  slidesPerView: "auto", // Dynamic slide resizing
  navigation: {
  ...
  on: {
    init: function () {
      console.log("Swiper initialized"); // Debugging
      if (this.slides.length <= 1) {
        this.loop = false; // Disable loop if only one slide
        this.slides[0].style.opacity = 1; // Show the first slide
...
// Adjust Swiper settings for mobile
