       ...
       <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('manage-service') }}" class="nav-item nav-link @if(Route::currentRouteName() == 'manage-service.page') active @endif">
                        <i class="fa fa-keyboard me-2"></i>Manage Service's
                    </a>
                    <a href="{{ route('manage-project') }}" class="nav-item nav-link @if(Route::currentRouteName() == 'manage-project.page') active @endif">
