        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="{{ route('profile') }}" class="dropdown-item">Manage User</a>
                    <a href="{{ route('profile') }}" class="dropdown-item @if(Route::currentRouteName() == 'profile') active @endif">My Profile</a>
                </div>
            </div>
        </div>
    </nav>
