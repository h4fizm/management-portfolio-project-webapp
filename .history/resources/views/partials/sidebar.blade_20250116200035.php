<div class="sidebar pe-4 pb-3">
    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{ route('manage-skill') }}" class="nav-item nav-link dropdown-item @if(Route::currentRouteName() == 'manage-skill.page') active @endif">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <!-- Dynamically pass the authenticated user's ID to the profile page -->
