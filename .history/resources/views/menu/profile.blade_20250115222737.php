...
<div class="container-fluid pt-4 px-4">
    ...
    <!-- Ganti input file dengan Dropzone div -->
    <div id="resumeDropzone" class="dropzone"></div>
...
$(document).ready(function() {
    // Pastikan Dropzone sudah terhubung dengan div yang memiliki id 'resumeDropzone'
