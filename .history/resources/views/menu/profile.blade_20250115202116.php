            ...
            <div class="bg-light rounded h-100 p-4">
                ...
                @method('PUT')
                   ...
                   <div class="mb-3">
                        ...
                        <input type="file" class="filepond" name="resume" id="formFileResume" accept=".pdf,.doc,.docx">
...
@section('scripts')
<!-- Tambahkan CSS dan JS FilePond -->
<link href="https://unpkg.com/filepond/dist/filepond.css" rel="stylesheet">
<script src="https://unpkg.com/filepond/dist/filepond.js"></script>

<script>
    // Aktifkan FilePond pada elemen input file
    ...
    // Konfigurasi FilePond untuk mengunggah ke server
    FilePond.setOptions({
        server: {
