      ...
      <div class="modal-body">
        <form id="addSkillForm">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="skillName" name="skill_name" placeholder="Enter skill name">
          </div>
          <div class="text-end">
...
<script>
    ...
    // Contoh untuk menangani submit form (untuk sekarang hanya console.log data form)
    document.getElementById('addSkillForm').addEventListener('submit', function(e) {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Skill added!',
            text: `Skill "${skillName}" has been added.`,
        });
