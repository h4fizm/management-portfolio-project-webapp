...
<script>
    function openEditModal(projectId, projectName, projectDescription, projectService, projectLink) {
        ...
        document.getElementById('serviceName').value = projectService;
        ...
        form.action = '/manage-project/update/' + projectId; // Sesuaikan URL dengan route
    }
