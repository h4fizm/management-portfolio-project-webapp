...
let swiperContainer = document.querySelector(".services-box-services");
let slides = swiperContainer.querySelectorAll(".swiper-slide");

// Cek jumlah slide dan atur konfigurasi Swiper
let swiperConfig = {
  loop: slides.length > 1, // Loop hanya aktif jika lebih dari 1 slide
  spaceBetween: 10,
  slidesPerView: 1, // Tampilkan satu slide pada satu waktu
  navigation: {
...
// Inisialisasi Swiper
let swiperPortfolio = new Swiper(".services-box-services", swiperConfig);

// Jika hanya ada satu slide, tambahkan kelas khusus
if (slides.length === 1) {
