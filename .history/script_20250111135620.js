...
let swiperPortfolio = new Swiper(".services-box-services", {
  ...
  slidesPerView: 3, // Default di desktop, menampilkan 3 slide
  navigation: {
...
// Adjust Swiper for mobile screens
function updateSwiperForMobile() {
  const isMobile = window.matchMedia("(max-width: 500px)").matches;
  if (isMobile) {
    swiperPortfolio.params.slidesPerView = 1; // Hanya satu slide untuk mobile
    swiperPortfolio.update(); // Update konfigurasi Swiper
  } else {
    swiperPortfolio.params.slidesPerView = 3; // Kembali ke 3 slide untuk desktop
