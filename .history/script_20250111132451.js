...
let swiperPortfolio = new Swiper(".services-box-services", {
  ...
  breakpoints: {
    // You can adjust for different screen sizes if needed
    640: {
      slidesPerView: 1, // For mobile, show only one slide in the center
    },
    768: {
      slidesPerView: "auto", // For tablet and larger screens, use 'auto'
    },
  },
});
